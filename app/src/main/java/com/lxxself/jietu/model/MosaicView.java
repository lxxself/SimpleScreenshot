package com.lxxself.jietu.model;
...
public class MosaicView extends ViewGroup {
	...
	private static final int MOSAIC_COLOR = Color.parseColor("#ff0000");
	...
	public void setSrcImage(Bitmap bitmap) {
		Log.d(TAG, "1111" + bitmap.isRecycled());
		reset();
		mImageHeight = bitmap.getHeight();
		mImageWidth = bitmap.getWidth();

		bmBaseLayer = bitmap;
		Log.d(TAG, "1111"+bmBaseLayer.isRecycled());
		bmCoverLayer = getCoverLayer();
		bmMosaicLayer = null;
...
//		updateView();
	...
	private Bitmap getBlurMosaic() {
		...
		Bitmap bitmap = BitmapUtil.blur(bmBaseLayer,mRadius);
		return bitmap;
	}
